...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            try {
                //BigInteger tmp;
                //tmp = block.getDifficultyTargetAsInteger();
                //log.info( "expecting diff of  " + tmp.toString(16) );
                block.verifyHeader();
            ...
            if (storedPrev == null) {
                ...
                //verifyDifficulty( Utils.decodeCompactBits( storedPrev.getHeader().getDifficultyTarget() ), storedPrev, block );
                //verifyDifficulty( Utils.decodeCompactBits(0x1f00ffffL), storedPrev, block );
                /* cryptodad Jun 2019 implement DGW3 end */
