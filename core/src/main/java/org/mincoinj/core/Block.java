...
import static org.mincoinj.core.Coin.*;
import static org.mincoinj.core.Sha256Hash.*;
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 1 * 60 * 60; /* cryptodad Jun 2019 - mincoin */
    ...
    public static final long EASIEST_DIFFICULTY_TARGET = 0x1f0fffffL; //0x207fFFFFL; /* cryptodad this might need looking in to further */
    ...
    Block(NetworkParameters params, long setVersion) {
        ...
        version = setVersion;
        difficultyTarget = 0x1f00ffffL;//0x1e0ffff0L; //0x1d07fff8L; /* cryptodad this might need looking in to further */
    ...
    private Sha256Hash calculateScryptHash() {
        try {
            ...
            log.error("SHOULD NEVER SEE THIS"); /* cryptodad Jun 2019 */
            throw new RuntimeException(e); // Cannot happen.
        }
    }
    ...
    public String getHashAsString() {
        ...
        //return getScryptHash().toString(); /* cryptodad Jun 2019 - Mincoin uses Scrypt */
    }
    ...
    public BigInteger getDifficultyTargetAsInteger() throws VerificationException {
        ...
        //BigInteger target = Utils.decodeCompactBits(0x1f00ffffL);
    ...
    public static byte[] scryptDigest(byte[] input) {
        try {
            //log.info( "here i am 5");
            return SCrypt.scrypt(input, input, 1024, 1, 1, 32);
        } catch (Exception e) {
            log.error("SCrypt exception - " +  e );
            return null;
        }
    }
    ...
    protected boolean checkProofOfWork(boolean throwException) throws VerificationException {
        ...
        //do scrypt stuff here???

        Sha256Hash pow = getProofOfWork(this);  /* cryptodad Jun 2019 - Mincoin uses Scrypt */

        h = pow.toBigInteger();

        //log.info( "target = " + target.toString(16) + ", h = " + h.toString(16 ) );
