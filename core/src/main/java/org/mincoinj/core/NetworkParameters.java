...
import org.mincoinj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.mincoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.mincoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.mincoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.mincoinj.unittest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            */
            ...
            /* cryptodad May 2019 - new testnet4 matches mainnet */
    ...
    public static final long MAX_COINS = 10000000; /* cryptodad May 2019 mincoin limit */
    ...
    public static NetworkParameters fromID(String id) {
        if (id.equals(ID_MAINNET)) {
            ...
            //return TestNet3Params.get(); /* cryptodad */
    ...
    public static enum ProtocolVersion {
        ...
        BLOOM_FILTER_BIP111(70013), // BIP111
        WITNESS_VERSION(70014),
        CURRENT(70015);
