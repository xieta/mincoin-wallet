...
public class Networks {
    /** Registered networks */
    private static Set<? extends NetworkParameters> networks = ImmutableSet.of(TestNet4Params.get(), MainNetParams.get()); //ImmutableSet.of(TestNet4Params.get(), MainNetParams.get());
