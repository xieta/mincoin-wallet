...
from mincoinj.core import *

import mincoinj.crypto.KeyCrypterException
import mincoinj.params.MainNetParams
from mincoinj.kits import WalletAppKit
...
if __name__ == "__main__":
    params = mincoinj.params.TestNet3Params.get()
