...
import org.mincoinj.wallet.DefaultRiskAnalysis;
import org.mincoinj.wallet.RiskAnalysis.Result;
...
public class WatchMempool {
    ...
    private static final NetworkParameters PARAMS = TestNet4Params.get(); //MainNetParams.get();
